...
const ConfigureSlot1 = ({ navigation, route }) => {
          ...
          <View style={{ flexDirection: 'row', width: w }}>
            ...
            <View style={{ width: '50%', backgroundColor: Colors.blue }}>
              <Button
                ...
                onPress={() =>
                  navigation.navigate('ConfigureSlot2', {
                    id: route.params.id,
                    name: route.params.name,
...
export default ConfigureSlot1;

export const ConfigureSlot2 = ({ navigation, route }) => {
  ...
  function handleAddSlot() {
    if (
      ...
      CFormFetch('/Management/ConfigureSlot', token, formData)
        .then(res => {
          if (res.status == 200) {
            navigation.navigate('Configure', {
              id: route.params.id,
            ...
            <SafeAreaView style={{ flex: 1 }}>
              <Pressable
                ...
                <Pressable style={mstyles.modalView}>
                  <Text style={mstyles.modalText}>Auto fill booking amount</Text>
                  <Text>
              ...
              <Pressable
                ...
                <Pressable style={mstyles.modalView}>
                  ...
                  <View
                    ...
                    <TouchableOpacity onPress={() => showDatepicker(1)}>
                      <TextInput
                        style={[mstyles.cinputTxt, { width: 150, paddingVertical: Platform.OS === "ios" ? 10 : 0 }]}
                        selectionColor="#009783"
                        placeholderTextColor="#949494"
                  ...
                  <TextInput
                    ...
                    style={[mstyles.cinputTxt, { width: 190, marginTop: 10, paddingVertical: Platform.OS === "ios" ? 10 : 0 }]}
                    onChangeText={val =>
